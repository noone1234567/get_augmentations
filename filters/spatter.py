...
class MySpatter(VideoProcessor):
    ...
    def get_ranges(self):
        # получатся уже не те значение как те что сверху !!!
        ranges = {'std':[0, 1], 'intensity':[0, 1], 'gauss_sigma':[0, 10]} # можно потом в единый файл для всех фильтров поставить и вытаскивать оттуда
        return ranges
